...
// Permissions - Permission management for knowledge bases
...
func newPermissions(rootSDK *Pipeshub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Permissions {
	return &Permissions{
		rootSDK:          rootSDK,
...
func (s *Permissions) GrantKBAccess(ctx context.Context, kbID string, body operations.CreateKBPermissionRequestBody, opts ...operations.Option) (*operations.CreateKBPermissionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/knowledgeBase/{kbId}/permissions", request, nil)
	if err != nil {
	...
	res := &operations.CreateKBPermissionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateKBPermissionResponseBody
...
func (s *Permissions) List(ctx context.Context, kbID string, opts ...operations.Option) (*operations.ListKBPermissionsResponse, error) {
	...
	res := &operations.ListKBPermissionsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListKBPermissionsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Permissions) Update(ctx context.Context, kbID string, body operations.UpdateKBPermissionsRequestBody, opts ...operations.Option) (*operations.UpdateKBPermissionsResponse, error) {
	...
	res := &operations.UpdateKBPermissionsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Permissions) DeleteFromKB(ctx context.Context, kbID string, body operations.DeleteKBPermissionsRequestBody, opts ...operations.Option) (*operations.DeleteKBPermissionsResponse, error) {
	...
	res := &operations.DeleteKBPermissionsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
