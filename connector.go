...
func (s *Connector) ReindexRecord(ctx context.Context, recordID string, body *operations.ReindexRecordRequestBody, opts ...operations.Option) (*operations.ReindexRecordResponse, error) {
...
func (s *Connector) Resync(ctx context.Context, request operations.ResyncConnectorRequest, opts ...operations.Option) (*operations.ResyncConnectorResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/knowledgeBase/resync/connector")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
