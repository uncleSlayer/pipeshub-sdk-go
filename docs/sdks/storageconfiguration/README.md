...
<!-- UsageSnippet language="go" operationID="getStorageConfig" method="get" path="/configurationManager/storageConfig" -->
```go
package main
...
func main() {
    ...
    res, err := s.StorageConfiguration.Get(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
**[*operations.GetStorageConfigResponse](../../models/operations/getstorageconfigresponse.md), error**
