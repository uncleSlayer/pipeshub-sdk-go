...
func newOauth(rootSDK *Pipeshub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Oauth {
	return &Oauth{
		rootSDK:          rootSDK,
...
func (s *Oauth) ExchangeCode(ctx context.Context, request components.OAuthExchangeRequest, opts ...operations.Option) (*operations.ExchangeOAuthCodeResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/userAccount/oauth/exchange")
	if err != nil {
	...
	res := &operations.ExchangeOAuthCodeResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.OAuthExchangeResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.OAuthExchangeResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
