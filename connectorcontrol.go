...
func newConnectorControl(rootSDK *Pipeshub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ConnectorControl {
...
// </ul>
func (s *ConnectorControl) Toggle(ctx context.Context, connectorID string, body components.ConnectorToggleRequest, opts ...operations.Option) (*operations.ToggleConnectorResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/connectors/{connectorId}/toggle", request, nil)
	if err != nil {
	...
	res := &operations.ToggleConnectorResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ToggleConnectorResponseBody
